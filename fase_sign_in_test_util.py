...
def SignInProcedure(fase_server_, session_info, screen_info, sign_in_id_list,
...
def testSignOutProcedure(fase_server_, session_info, screen_info, sign_out_id_list):
  ...
  # Click on Sign Out button.
  response = fase_server_.ElementClicked(fase_model.ElementClicked(['sign_out_layout_id', 'sign_out_button_id']),
                                         session_info, screen_info)
  session_info = response.session_info
  screen_info = response.screen_info
