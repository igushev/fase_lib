...
MOVE_LIST = [
    ('hello_world_fase/application.py', 'application.py'),
    ('hello_world_fase/requirements.txt', 'requirements.txt')
]
...
def main(argv):
  ...
  hello_world_version = version_util.ReadAndUpdateVersion(HELLO_WORLD_VERSION_FILENAME, update_position)
